...
namespace Microsoft.Kinect.Toolkit.Fusion
{
    ...
    public class ReconstructionParameters : IEquatable<ReconstructionParameters>
    {
        ...
        /// </summary>
        /// <param name="voxelsPerMeter">Voxels per meter.</param>
        /// <param name="voxelsX">Number of Voxels in X.</param>
        /// <param name="voxelsY">Number ofVoxels in Y.</param>
        /// <param name="voxelsZ">Number ofVoxels in Z.</param>
        ...
        /// The declaration of the default constructor is used for marshalling operations.
        /// </summary>
